...
The plan after this is to then watch the following video: https://www.youtube.com/watch?v=Oe421EPjeBE and then create projects with it: https://www.youtube.com/watch?v=qwfE7fSVaZM (then proceed to creating my very own side project for fun while ensuring I nail down the concepts of Node)
